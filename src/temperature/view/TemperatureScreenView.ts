...
export type TemperatureScreenViewOptions = ScreenViewOptions;

export class TemperatureScreenView extends ScreenView {
  public constructor(model: TemperatureModel, providedOptions?: TemperatureScreenViewOptions) {
    ...
    // it the same way. See TemperatureScreenSummaryContent for the four content regions.
    const options = optionize<TemperatureScreenViewOptions, EmptySelfOptions, ScreenViewOptions>()(
      {
    ...
    const placeholderText = new Text("Temperature", {
