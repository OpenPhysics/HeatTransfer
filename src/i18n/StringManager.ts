...
export class StringManager {
  ...
  public getScreenNames(): {
    readonly temperatureStringProperty: ReadOnlyProperty<string>;
    readonly conductionStringProperty: ReadOnlyProperty<string>;
    readonly convectionStringProperty: ReadOnlyProperty<string>;
    readonly combinedStringProperty: ReadOnlyProperty<string>;
    readonly materialsStringProperty: ReadOnlyProperty<string>;
  } {
    return {
      temperatureStringProperty: stringProperties.screens.temperatureStringProperty,
      conductionStringProperty: stringProperties.screens.conductionStringProperty,
      convectionStringProperty: stringProperties.screens.convectionStringProperty,
      combinedStringProperty: stringProperties.screens.combinedStringProperty,
      materialsStringProperty: stringProperties.screens.materialsStringProperty,
    };
  }
  ...
  /** Accessibility strings for the Conduction screen. */
  public getConductionA11yStrings() {
    return stringProperties.a11y.conduction;
  }

  /** Accessibility strings for the Convection screen. */
  public getConvectionA11yStrings() {
    return stringProperties.a11y.convection;
  }

  /** Accessibility strings for the Heat Transfer screen. */
  public getHeatTransferA11yStrings() {
    return stringProperties.a11y.combined;
  }

  /** Accessibility strings for the Materials screen. */
  public getMaterialsA11yStrings() {
    return stringProperties.a11y.materials;
  }
