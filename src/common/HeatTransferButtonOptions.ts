...
export const LIGHT_SURFACE_TEXT_FILL = HeatTransferColors.controlSurfaceTextColorProperty;

/**
 * Combo-box chrome for panels. Item labels must use {@link LIGHT_SURFACE_TEXT_FILL}, not
 * {@link HeatTransferColors.textColorProperty} — that color is for labels on the dark panel fill.
 */
export const HEAT_TRANSFER_COMBO_BOX_OPTIONS = {
  buttonFill: HeatTransferColors.controlSurfaceColorProperty,
  listFill: HeatTransferColors.controlSurfaceColorProperty,
  buttonStroke: HeatTransferColors.panelBorderColorProperty,
  listStroke: HeatTransferColors.panelBorderColorProperty,
...
export const TIME_CONTROL_SPEED_RADIO_OPTIONS = {
  speedRadioButtonGroupOptions: {
    labelOptions: { fill: HeatTransferColors.textColorProperty },
  },
