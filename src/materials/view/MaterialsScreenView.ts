...
export type MaterialsScreenViewOptions = ScreenViewOptions;

export class MaterialsScreenView extends ScreenView {
  public constructor(model: MaterialsModel, providedOptions?: MaterialsScreenViewOptions) {
    ...
    // it the same way. See MaterialsScreenSummaryContent for the four content regions.
    const options = optionize<MaterialsScreenViewOptions, EmptySelfOptions, ScreenViewOptions>()(
      {
    ...
    const placeholderText = new Text("Materials", {
